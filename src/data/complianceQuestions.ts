...
export const PROJECT_PHASES: QuestionPhase[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 'p6_epc', type: 'select', label: 'What is the current EPC rating of the properties in scope?', options: ['Select…', 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'Mixed / unknown'] },
      { id: 'p6_target_epc', type: 'select', label: 'What is the target EPC rating post-works?', options: ['Select…', 'A', 'B', 'C', 'D', 'Not applicable'] },
  ...
  },
  {
    ...
    questions: [
      { id: 'p7_route', type: 'select', label: 'What procurement route is being used for this project?', options: ['Select…', 'Open procedure', 'Restricted procedure', 'Competitive dialogue', 'Direct award (framework call-off)', 'Direct award (waiver)', 'Design and build', 'Traditional (separate design)', 'Two-stage tender'] },
      ...
      { id: 'p7_form', type: 'select', label: 'What contract form is being used?', options: ['Select…', 'JCT Standard Building Contract', 'JCT Design and Build', 'NEC4 ECC', 'NEC4 PSC', 'PCSA', 'Other bespoke form', 'Not yet determined'] },
