...
import {
  Calculator, Save, RefreshCw, Database, Brain, Server, HardDrive,
  HeadphonesIcon, Wrench, GraduationCap, Loader2, CheckCircle,
  TrendingUp, AlertCircle, BarChart, Users, Building2, Zap, ChevronDown, ChevronUp
} from 'lucide-react';
...
export function CostCalculator() {
  ...
  const isAdmin = isSuperAdmin(user?.email, user?.profile?.role);
    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_380px] gap-6">
        ...
        <div className="space-y-4">
          ...
          <RateSection title="Gemini AI (Flash)" icon={Brain} color="bg-purple-50 text-purple-600">
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
