...
import { Settings2, Building2, Users, Bell, Save, Plus, Mail, Trash2, Loader2, CheckCircle2, Clock, User2, FolderKanban, Database, AlertTriangle, RefreshCcw, Wand2, ShieldCheck, Globe } from 'lucide-react';
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                        ...
                        <div className="space-y-6">
                            <div className="bg-indigo-600 rounded-[28px] sm:rounded-[32px] p-6 sm:p-8 text-white shadow-2xl shadow-indigo-200 relative overflow-hidden group">
                                <Wand2 className="absolute -top-10 -right-10 w-40 h-40 text-white/10 rotate-12 transition-transform group-hover:scale-110" />
