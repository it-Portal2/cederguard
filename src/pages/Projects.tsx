...
import { isAtLeastPM, isAtLeastClientAdmin, isSuperAdmin } from '../lib/roles';
...
export function Projects() {
    ...
    const canCreate = isAtLeastPM(userRole);
    const canEdit = isAtLeastPM(userRole);
    const canDelete = isAtLeastPM(userRole);
