...
import { FolderKanban, Loader2, Plus, TrendingUp, Milestone, Shield, ShieldCheck, Wand2, Brain, AlertTriangle, CheckCircle, PoundSterling, BarChart, ListFilter, ShieldAlert, ArrowLeft, Eye, ChevronRight, Trash2, LayoutTemplate, FileBarChart, PieChart, Layers, BookOpen, AlertCircle, ArrowRight, Star, Calendar } from 'lucide-react';
...
export function Dashboard() {
  ...
  const isClientAdmin = (isAtLeastClientAdmin(userRole) || isAdmin) && !isViewingAsPM;
  ...
  const isComplianceSetup = complianceAnalysis !== null && contextCompliance.length > 0;
          ...
          <div className="bg-slate-900 rounded-2xl border border-slate-800 overflow-hidden shadow-xl relative">
            ...
            <div className="bg-white/5 border-b border-white/10 px-6 py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4 relative z-10">
              ...
              {!strategicInsights ? (
                ...
                >
                  {generatingInsights ? <Loader2 className="w-3 h-3 animate-spin" /> : <Wand2 className="w-3 h-3 text-white/80" />}
                ...
                <div className="flex items-center gap-4">
                  ...
                  >
                    <Wand2 className="w-3 h-3" /> Refresh Report
                  </button>
                </div>
              )}
            </div>
                        ...
                        {strategicInsights.detailedSuggestions && strategicInsights.detailedSuggestions.length > 0 && (
                          <div className="mt-8 pt-8 border-t border-white/10">
                            ...
                            <div className={clsx(
                              ...
                              {!showFullDetails && (
                                <div className="absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-slate-900 via-slate-900/80 to-transparent z-10 pointer-events-none flex items-end justify-center pb-2">
                                  <button 
                              ...
                              {Array.isArray(strategicInsights.detailedSuggestions) && strategicInsights.detailedSuggestions.map((s: string, i: number) => {
                                ...
                                return (
                                  <div key={i} className="flex flex-col gap-3 bg-emerald-500/5 p-4 rounded-xl border border-emerald-500/10 transition-all hover:bg-emerald-500/10 group">
                                    <div className="flex items-start gap-3">
                                      <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-emerald-500/10 flex items-center justify-center border border-emerald-500/20 group-hover:scale-105 transition-transform">
          ...
          <div className="mt-8">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
              ...
              <div className="flex flex-col gap-4">
                <div className="bg-gradient-to-br from-indigo-900 to-slate-900 rounded-3xl p-6 border border-indigo-800 shadow-xl relative overflow-hidden group">
        ...
        <div className="space-y-4">
          ...
          {isComplianceSetup ? (
            <>
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-4 md:p-5 flex flex-col md:flex-row md:items-center gap-4 md:gap-6 shadow-sm">
                ...
                <div className="flex-1 h-3 bg-slate-100 rounded-full overflow-hidden shadow-inner">
                  <div className="h-full bg-gradient-to-r from-emerald-500 to-teal-400 transition-all duration-1000 ease-out" style={{ width: `${compPct}%` }} />
                </div>
            ...
            <div className="bg-white rounded-2xl border-2 border-dashed border-slate-200 p-8 flex flex-col items-center justify-center text-center">
              ...
              >
                <Wand2 className="w-3.5 h-3.5" /> Start AI Setup
              </Link>
            </div>
          )}
        </div>
          ...
          {isRiskSetup ? (
            ...
            <div className="bg-white rounded-2xl border-2 border-dashed border-slate-200 p-8 flex flex-col items-center justify-center text-center">
              ...
              <Link 
                ...
                className="mt-4 flex items-center gap-2 px-5 py-2 bg-indigo-600 text-white text-xs font-bold rounded-xl hover:bg-indigo-700 transition-colors shadow-sm"
              >
                <Brain className="w-3.5 h-3.5" /> Launch AI Risk ID
              </Link>
            </div>
          )}
        </div>
