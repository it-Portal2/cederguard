...
import { isSuperAdmin, isAtLeastClientAdmin, canCreateProject, canCreateProgramme } from '../lib/roles';
                            ...
                            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
                                <div className="max-w-2xl mx-auto text-center space-y-4">
                                    ...
                                    {projectRisks.length === 0 ? (
                                        ...
                                        >
                                            <Cpu className="w-4 h-4 inline mr-2" /> Run Sensitivity Analysis
                                        </button>
                                    )}
                                </div>
