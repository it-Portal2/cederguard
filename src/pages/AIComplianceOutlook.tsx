...
import { Brain, Wand2, ArrowRight, CheckCircle2, ShieldCheck, AlertCircle } from 'lucide-react';
            ...
            <div className="flex justify-between items-end">
                <div>
                    <h1 className="text-2xl font-black text-slate-900 flex items-center gap-2">
                        <Brain className="w-7 h-7 text-indigo-600" /> Compliance Posture Outlook
                    </h1>
