...
import {
    ClipboardList, BarChart, Activity, ShieldPlus, Bell,
    ClipboardCheck, ShieldCheck, Library, Cpu, UploadCloud,
    PieChart, FileText, Building2, Users, LayoutDashboard,
    ArrowRight, Wand2, Shield, CheckCircle2, LayoutGrid, Target,
    Globe, Lock, History, Scale, GraduationCap
} from 'lucide-react';
...
const aiFeatures = [
    ...
    { title: 'Compliance Summary', icon: Cpu },
    ...
    return (
        <div className="bg-slate-50 dark:bg-[#030303] text-slate-600 dark:text-slate-300 font-sans antialiased selection:bg-cyan-500/30 selection:text-white min-h-screen transition-colors duration-500">
            ...
            <div className="max-w-6xl mx-auto px-6 mb-32 relative z-10">
                ...
                >
                    {[
                        { label: 'Integrated Capabilities', value: '15+', icon: Wand2, color: 'text-indigo-500' },
