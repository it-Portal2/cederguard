...
import { Brain, Wand2, Building2, ShieldAlert, FileWarning, ArrowRight, Settings, Check, Loader2, CheckCircle2 } from 'lucide-react';
...
export function RiskSetup() {
    ...
    const isClientAdmin = userRole === 'admin' || userRole === 'client_admin';
                        ...
                        {!done && (
                            <div className="space-y-10">
                                {currentQuestions.map((phase, idx) => (
                                    ...
                                    >
                                        <div className="px-10 py-8 border-b border-slate-100/50 flex items-center justify-between bg-gradient-to-r from-white/40 to-transparent">
