...
import {
  HelpCircle, BookOpen, Users, Shield, LayoutDashboard, CheckSquare,
  AlertTriangle, FileWarning, Brain, Wand2, BarChart, ClipboardList,
  PieChart, Settings2, FolderKanban, KeyRound, Terminal, Search,
  ChevronDown, ChevronRight, CheckCircle2, ArrowRight, Lightbulb,
  Target, BellRing, ScrollText, FileText, Lock, TrendingUp, Layers,
  Building2, Plus, Activity
} from 'lucide-react';
            ...
            <AIInquiryPopup 
              trigger={
                <button className="inline-flex items-center gap-1.5 text-sm font-semibold text-indigo-600 hover:text-indigo-700">
                  <Brain className="w-4 h-4" /> Ask AI Regulatory Guide
                </button>
              }
            />
