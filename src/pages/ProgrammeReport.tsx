import { 
    LayoutDashboard, ShieldCheck, AlertTriangle, FileWarning, 
    TrendingUp, Layers, ListChecks, Zap, ArrowRight,
    TrendingDown, BarChart, PieChart, Loader2, CheckCircle2,
    Shield, PoundSterling, ArrowLeft, ShieldAlert, AlertCircle, Cpu, Plus
} from 'lucide-react';
                        ...
                        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
                            <div className="max-w-2xl mx-auto text-center space-y-4">
                                ...
                                {!analysisResults && !isAnalyzing && (
                                    ...
                                    >
                                        <Cpu className="w-4 h-4 inline mr-2" /> Run Portfolio Sensitivity
                                    </button>
                                )}
                            </div>
