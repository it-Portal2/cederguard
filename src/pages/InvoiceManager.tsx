...
import {
  Calculator, ChevronDown, ChevronUp, Info, TrendingUp, DollarSign,
  Users, Building2, FolderKanban, Brain, Database, Server,
  HeadphonesIcon, GraduationCap, Shield, Download, RefreshCw,
  AlertCircle, CheckCircle, Zap, HardDrive, Globe, BarChart, Save, Loader2,
  PoundSterling, ArrowRight, Layers, XCircle, Plus, FileText, X, Settings, Trash2
} from 'lucide-react';
          ...
          <div className="grid grid-cols-1 xl:grid-cols-[380px_1fr] gap-6">
            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <SectionCard icon={Brain} title="Gemini 2.5 AI" color="bg-purple-50 text-purple-600" onToggle={e => toggleExclusion('gemini', e)} isExcluded={isExcluded('gemini')}>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3 mt-1">
                        <span className="text-xs font-medium text-slate-500 flex items-center gap-1">
                          <Zap className="w-3 h-3 text-amber-500" /> {inv.date}
                        </span>
