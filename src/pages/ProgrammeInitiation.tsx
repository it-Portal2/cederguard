...
import {
    LayoutTemplate, Save, ArrowLeft, Shield, AlertTriangle, AlertCircle,
    ChevronRight, CheckCircle2, Wand2, Lightbulb, Info,
    DollarSign, Rocket, CheckSquare, Target, Trash2, Users, Plus
} from 'lucide-react';
...
export function ProgrammeInitiation() {
    ...
    const _userRole = (user as any)?.profile?.role;
