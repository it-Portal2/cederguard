...
import { 
    Shield, CheckCircle2, ChevronRight, ChevronLeft, 
    ArrowLeft, Info, AlertTriangle, FileText, 
    Zap, Home, Building2, FlameKindling, Leaf
} from 'lucide-react';
...
const QUESTIONS = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'No - Standard Maintenance', value: 'retrofit_no', icon: Zap },
    ]
  }
];
