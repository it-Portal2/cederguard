...
import { X, ShieldAlert, Zap, AlertTriangle, ArrowRight } from 'lucide-react';
                                    ...
                                    {isAddingAction && (
                                        <div className="bg-white border-2 border-indigo-100 p-4 rounded-xl shadow-md animate-in slide-in-from-top-2 duration-200">
                                            ...
                                            <input 
                                                ...
                                                className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-indigo-500 mb-3"
                                                onKeyDown={e => {
                                                    if (e.key === 'Enter' && newActionTitle) {
                                                        addTask({
                                                            id: generateId('TSK'),
                                            ...
                                            <div className="flex justify-end gap-2">
                                                <button onClick={() => setIsAddingAction(false)} className="px-3 py-1.5 text-xs font-medium text-slate-500 hover:bg-slate-100 rounded-lg">Cancel</button>
                                                <button 
                                                    disabled={!newActionTitle}
                                                    onClick={() => {
                                                        addTask({
                                                            id: generateId('TSK'),
                                                            title: newActionTitle,
