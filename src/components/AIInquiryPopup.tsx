...
import { X, Wand2, Send, MessageSquare, Sparkles, Loader2, Bot, HelpCircle, ArrowRight, ShieldCheck, AlertTriangle, Copy, Check } from 'lucide-react';
  ...
  useEffect(() => {
    if (isOpen && messages.length === 0) {
      const welcomeMsg: Message = {
        id: 'welcome',
        role: 'assistant',
        content: `Hello! I'm CedarGuard AI. I have context on your current ${projectInfo.name ? 'project profile' : 'compliance setup'}. How can I assist you with your regulatory requirements or risk posture today?`,
        timestamp: new Date()
      };
        ...
        <div className="p-6 bg-slate-900 border-b border-slate-800 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-400 text-[10px] uppercase font-bold tracking-wider mt-0.5">Context: Compliance Intelligence</p>
            </div>
          </div>
          <button 
            onClick={handleClose}
